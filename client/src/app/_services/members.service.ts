...
import { map, mapTo, reduce, take } from 'rxjs/operators';
...
export class MembersService {
  ...
  deleteMember(member: Member){
    return this.http.delete(this.baseUrl + 'users/delete-account/' + member.username);
  }
  ...
  removeLike(username: string){
    return this.http.post(this.baseUrl + 'likes/unlike/' + username, {});
  }
